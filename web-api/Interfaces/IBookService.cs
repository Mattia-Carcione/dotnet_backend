...
public interface IBookService
{
    ...
    /// </summary>
    /// <param name="email">The email of the user making booking.</param>
    ...
    Task<Booking> BookingAsync(string email, int bookId);

    /// <summary>
    /// Updates the booking status when a book is returned by a user.
    /// </summary>
    /// <param name="email">The email of the user returning the book.</param>
    ...
    Task UpdateBookingAsync(string email, int bookingId, int bookId);
}
